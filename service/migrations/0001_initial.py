# Generated by Django 5.2.11 on 2026-02-26 08:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, default="", verbose_name="وصف التصنيف"
                    ),
                ),
                (
                    "icon",
                    models.CharField(
                        blank=True, default="", max_length=10, verbose_name="أيقونة"
                    ),
                ),
                (
                    "order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tts_play_count",
                    models.PositiveIntegerField(
                        default=0, verbose_name="مرات القراءة الصوتية"
                    ),
                ),
                (
                    "category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=200, verbose_name="عنوان الاستفسار"),
                ),
                (
                    "question_text",
                    models.TextField(blank=True, default="", verbose_name="نص السؤال"),
                ),
                (
                    "question_audio",
                    models.FileField(
                ...
                (
                    "transcription_text",
                    models.TextField(blank=True, default="", verbose_name="نص التفريغ"),
                ),
                (
                    "answer_text",
                    models.TextField(blank=True, default="", verbose_name="نص الإجابة"),
                ),
                (
                    "answered_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="تاريخ الإجابة"
                    ),
                ),
                (
                    "status",
